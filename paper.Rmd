...
We fit a Cox proportional hazards model to the pre haart era data. We did not allow secondary aids diagnosis to be time varying. 
```{r naive-survival}
